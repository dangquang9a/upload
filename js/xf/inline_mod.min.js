...
c.length?this.loadBar():this.hideBar();return c},onToggle:function(a){a=b(a.target);var c=a.is(":checked");var d=this.toggleSelectedInCookie(a.val(),c);this.toggleContainer(a,c);d.length?this.loadBar():this.hideBar()},onActionTrigger:function(a){a.preventDefault();this.loadBar()},loadBar:function(a){var c=this;this.loadTimeout&&clearTimeout(this.loadTimeout);this.loadTimeout=setTimeout(function(){c.xhr&&c.xhr.abort();c.xhr=XF.ajax("GET",c.options.href,{type:c.options.type},function(b){c._showBar(b,
a)})},10)},_showBar:function(a,c){this.xhr=null;if(a.html){var d=this;XF.setupHtmlInsert(a.html,function(a,f,g){f=!1;d.$bar&&(f=!0,d.$bar.remove(),d.$bar=null);d._setupBar(a);d.$bar=a;XF.bottomFix(a);if(XF.browser.ios){var e=b('<div class="inlineModBarCover" />'),h=d.$bar,k=h.find(".js-inlineModAction");e.click(function(){k.blur()});k.on({focus:function(){h.before(e)},blur:function(){setTimeout(function(){e.remove()},200)}})}f&&a.css("transition-duration","0s");a.addClassTransitioned("is-active");
f&&setTimeout(function(){a.css("transition-duration","")},0);c&&c(a)})}},_setupBar:function(a){a.on("click",":submit",XF.proxy(this,"submit")).on("click",".js-inlineModClose",XF.proxy(this,"hideBar")).on("click",".js-inlineModSelectAll",XF.proxy(this,"onSelectAllClick"));var c=this.$target.find(this.options.toggle);c.length==c.filter(":checked").length&&a.find("input[type=checkbox].js-inlineModSelectAll").prop("checked",!0)},onSelectAllClick:function(a){b(a.target).is(":checked")?this.selectAll().length?
this.loadBar(function(a){a.find("input[type=checkbox].js-inlineModSelectAll").prop("checked",!0)}):this.deselect():this.deselectPage()},submit:function(){if(this.$bar){var a=this.$bar.find(".js-inlineModAction");if(a.length){if(a=a.val())if("deselect"==a)this.deselect();else{var c=this;XF.ajax("POST",this.options.href,{type:this.options.type,action:a},function(a){c._handleSubmitResponse(a)},{skipDefaultSuccess:!0})}}else console.error("No action selector found.")}},_handleSubmitResponse:function(a){a.html?
XF.setupHtmlInsert(a.html,function(a,b){a=XF.getOverlayHtml({html:a,title:b.h1||b.title});XF.showOverlay(a)}):"ok"==a.status&&a.redirect?a.message?XF.flashMessage(a.message,1E3,function(){XF.redirect(a.redirect)}):XF.redirect(a.redirect):XF.alert("Unexpected response");this.hideBar()},hideBar:function(){if(this.$bar){var a=this;this.$bar.removeClassTransitioned("is-active",function(){a.$bar&&a.$bar.remove();a.$bar=null})}},_updateCounter:function(a){var c=this.$target.find(this.options.actionTrigger),
b=c.find(".inlineModButton");b.length||(b=c);b.toggleClass("is-mod-active",0<a);this.$target.find(this.options.counter).text(a)},toggleContainer:function(a,c){c=c?"addClass":"removeClass";a.closest(this.options.toggleContainer)[c](this.options.containerClass)},toggleSelectedInCookie:function(a,c){a=parseInt(a,10);var d=this.getCookieValue(),e=b.inArray(a,d),f=!1;c?0>e&&(d.push(a),f=!0):0<=e&&(d.splice(e,1),f=!0);return f?this.setCookieValue(d):d},getCookieValue:function(){var a=XF.Cookie.get(this.cookie);
if(!a)return[];a=a.split(",");for(var c=a.length,b=0;b<c;b++)a[b]=parseInt(a[b],10);return a},setCookieValue:function(a){a.length?(a.sort(function(a,b){return a-b}),XF.Cookie.set(this.cookie,a.join(","))):XF.Cookie.remove(this.cookie);this._updateCounter(a.length);return a}});XF.Element.register("inline-mod","XF.InlineMod")}(jQuery,window,document);
