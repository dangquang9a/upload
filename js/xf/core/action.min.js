...
3E3)},click:function(a){c(a.target).select()}});XF.CopyToClipboard=XF.Element.newHandler({options:{copyText:"",copyTarget:"",success:""},copyText:null,init:function(){if(this.options.copyText)this.copyText=this.options.copyText;else if(this.options.copyTarget){var a=c(this.options.copyTarget);a.is('input[type="text"], textarea')?this.copyText=a.val():this.copyText=a.text()}this.copyText||console.error("No text to copy to clipboard");var b=this;(new Clipboard(this.$target[0],{text:function(a){return b.copyText}})).on("success",
function(){if(b.options.success)XF.flashMessage(b.options.success,3E3);else{var a=XF.phrase("text_copied_to_clipboard");b.copyText.match(/^[a-z0-9-]+:\/\/[^\s"<>{}`]+$/i)&&(a=XF.phrase("link_copied_to_clipboard"));XF.flashMessage(a,3E3)}})}});XF.PushToggle=XF.Element.newHandler({options:{},isSubscribed:!1,cancellingSub:null,init:function(){XF.Push.isSupported()?"denied"===Notification.permission?(this.updateButton(XF.phrase("push_blocked_label"),!1),console.error("Notification.permission === denied")):
this.registerWorker():(this.updateButton(XF.phrase("push_not_supported_label"),!1),console.error("XF.Push.isSupported() returned false"))},registerWorker:function(){var a=this;XF.Push.registerWorker(function(){a.$target.on("click",XF.proxy(a,"buttonClick"));c(g).on("push:init-subscribed",function(){a.updateButton(XF.phrase("push_disable_label"),!0)});c(g).on("push:init-unsubscribed",function(){a.updateButton(XF.phrase("push_enable_label"),!0)})},function(){a.updateButton(XF.phrase("push_not_supported_label"),
!1);console.error("navigator.serviceWorker.register threw an error.")})},buttonClick:function(a){var b=this;XF.Push.handleToggleAction(function(){b.updateButton(XF.phrase("push_enable_label"),!0);XF.Cookie.set("push_notice_dismiss","1");XF.config.userId&&XF.Push.removeUserFromPushHistory()},!1,function(){b.updateButton(XF.phrase("push_disable_label"),!0)},function(){b.updateButton(XF.phrase("push_not_supported_label"),!1)})},updateButton:function(a,b){this.$target.find(".button-text").text(a);b?this.$target.removeClass("is-disabled"):
this.$target.addClass("is-disabled")}});XF.PushCta=XF.Element.newHandler({options:{},init:function(){XF.config.skipPushNotificationCta||XF.Push.isSupported()&&"denied"!==Notification.permission&&(this.getDismissCookie()||this.registerWorker())},registerWorker:function(){var a=this;XF.Push.registerWorker(function(){c(g).on("push:init-unsubscribed",function(){if(XF.Push.hasUserPreviouslySubscribed())try{XF.Push.handleSubscribeAction(!0)}catch(b){XF.Push.removeUserFromPushHistory()}else a.$target.closest(".js-enablePushContainer").xfFadeDown(XF.config.speed.fast,
XF.proxy(a,"initLinks"))})})},initLinks:function(){var a=this.$target;a.find(".js-enablePushLink").on("click",XF.proxy(this,"linkClick"));a.siblings(".js-enablePushDismiss").on("click",XF.proxy(this,"dismissClick"))},linkClick:function(a){a.preventDefault();this.hidePushContainer();XF.Push.handleSubscribeAction(!1)},dismissClick:function(a){a.preventDefault();c(a.currentTarget).hide();this.$target.closest(".js-enablePushContainer").addClass("notice--accent").removeClass("notice--primary");this.$target.find(".js-initialMessage").hide();
a=this.$target.find(".js-dismissMessage");a.show();a.find(".js-dismissTemp").on("click",XF.proxy(this,"dismissTemp"));a.find(".js-dismissPerm").on("click",XF.proxy(this,"dismissPerm"))},dismissTemp:function(a){a.preventDefault();this.hidePushContainer();this.setDismissCookie(!1)},dismissPerm:function(a){a.preventDefault();this.hidePushContainer();this.setDismissCookie(!0)},setDismissCookie:function(a){a?XF.Cookie.set("push_notice_dismiss","1",new Date((new Date).setFullYear((new Date).getFullYear()+
10))):XF.Cookie.set("push_notice_dismiss","1")},getDismissCookie:function(){return XF.Cookie.get("push_notice_dismiss")},hidePushContainer:function(){this.$target.closest(".js-enablePushContainer").xfFadeUp(XF.config.speed.fast)}});XF.Reaction=XF.Element.newHandler({options:{delay:200,reactionList:null},$tooltipHtml:null,trigger:null,tooltip:null,href:null,init:function(){if(this.$target.is("a")&&this.$target.attr("href")){this.href=this.$target.attr("href");var a=c("#xfReactTooltipTemplate");a.length&&
(this.$tooltipHtml=c(c.parseHTML(a.html())),this.tooltip=new XF.TooltipElement(XF.proxy(this,"getContent"),{extraClass:"tooltip--reaction",html:!0}),this.trigger=new XF.TooltipTrigger(this.$target,this.tooltip,{maintain:!0,delayIn:this.options.delay,trigger:"hover focus touchhold",onShow:XF.proxy(this,"onShow"),onHide:XF.proxy(this,"onHide")}),this.trigger.init());this.$target.on("click",XF.proxy(this,"actionClick"))}},getContent:function(){var a=this.href;a=a.replace(/(\?|&)reaction_id=[^&]*(&|$)/,
