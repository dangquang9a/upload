...
class ConversationMessages extends AbstractController
{
	 ...
	 * @api-in str $attachment_key API attachment key to upload files. Attachment key content type must be conversation_method with context[conversation_id] set to this conversation ID.
	 *
