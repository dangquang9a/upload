...
class ConversationMessage extends AbstractController
{
	 ...
	 *
	 * @api-out ConversationMethod $message
	 */
	 ...
	 * @api-in str $attachment_key API attachment key to upload files. Attachment key content type must be conversation_method with context[message_id] set to this message ID.
	 *
